...
import { Home, User, Settings, Menu, LogOut, Dumbbell, Apple, Brain } from "lucide-react";
...
const navItems = [
  ...
  { href: "/dashboard/nutrition", label: "Nutrition", icon: <Apple size={20} /> },
  { href: "/dashboard/ai-coach", label: "AI Coach", icon: <Brain size={20} /> },
